...
- (void)SetupSubviews{
    for (int nIndex = 0; nIndex < 9; nIndex++) {
        ...
        [btn setBackgroundImage:[UIImage iconWithInfo:TBCityIconInfoMake(@"\U0000e758", 30, RGB(210, 236, 250))] forState:UIControlStateNormal];
        [btn setBackgroundImage:[UIImage iconWithInfo:TBCityIconInfoMake(@"\U0000e758", 30, ThemeColor)] forState:UIControlStateSelected];
        [self addSubview:btn];
    }
}
