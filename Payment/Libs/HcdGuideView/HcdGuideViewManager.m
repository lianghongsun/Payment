...
- (UIPageControl *)pageControl {
    if (_pageControl == nil) {
        ...
        _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:234./255. green:234./255. blue:234./255. alpha:1.];
        _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:125./255. green:153./255. blue:255./255. alpha:1.];
    }
    return _pageControl;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == self.images.count - 1) {
        ...
        cell.button.layer.borderColor = [ThemeColor CGColor];
    } else {
